    ...
    <div class="picker">
        ...
        <wxc-popup class="popup-wrapper"
                ...
                <div class="picker-item" :style="pickerItemStyle">
                    ...
                    <scroller class="picker-item-list"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_1_ref, index + 2)"
                              ...
                              @click="e=> clickScrollerItem(e, col_1_ref, index)"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_1_ref, col_1_list.length - 1 + 3)"
                              ...
                              :ref="col_1_ref + '_text_' + numAdd(col_1_list.length - 1 + 3)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
                        <text @disappear="e => disAppearPickItem(e, col_1_ref, col_1_list.length - 1 + 4)"
                              ...
                              :ref="col_1_ref + '_text_' + numAdd(col_1_list.length - 1 + 4)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
                ...
                <div class="picker-item" :style="pickerItemStyle">
                    ...
                    <scroller class="picker-item-list"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_2_ref, index + 2)"
                              ...
                              @click="e=> clickScrollerItem(e, col_2_ref, index)"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_2_ref, col_2_list.length - 1 + 3)"
                              ...
                              :ref="col_2_ref + '_text_' + numAdd(col_2_list.length - 1 + 3)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
                        <text @disappear="e => disAppearPickItem(e, col_2_ref, col_2_list.length - 1 + 4)"
                              ...
                              :ref="col_2_ref + '_text_' + numAdd(col_2_list.length - 1 + 4)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
                ...
                <div class="picker-item" :style="pickerItemStyle">
                    ...
                    <scroller class="picker-item-list"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_3_ref, index + 2)"
                              ...
                              @click="e=> clickScrollerItem(e, col_3_ref, index)"
                        ...
                        <text @disappear="e => disAppearPickItem(e, col_3_ref, col_3_list.length - 1 + 3)"
                              ...
                              :ref="col_3_ref + '_text_' + numAdd(col_3_list.length - 1 + 3)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
                        <text @disappear="e => disAppearPickItem(e, col_3_ref, col_3_list.length - 1 + 4)"
                              ...
                              :ref="col_3_ref + '_text_' + numAdd(col_3_list.length - 1 + 4)"
                              class="picker-item-text"
                              :style="pickerItemTextStyle"></text>
            ...
            <div :class="['picker-btn', isipx() ? 'ipx-bottom' : '']">
                <text class="picker-btn-text" :style="pickerBtnTextStyle" @click="change">确定</text>
                <text class="picker-btn-text" :style="pickerBtnTextStyle" @click="cancel">取消</text>
            </div>
        ...
        methods: {
            ...
            refreshColumns () {
                ...
                var timer = setTimeout(function(){
                    clearTimeout(timer)
                    _self.checkedItem(_self.col_1_ref, _self.checked_col_1, false)
                    timer = setTimeout(function(){
                        clearTimeout(timer)
                        _self.checkedItem(_self.col_2_ref, _self.checked_col_2, false)
                        timer = setTimeout(function(){
                            clearTimeout(timer)
                            _self.checkedItem(_self.col_3_ref, _self.checked_col_3, false)
            ...
            finalSelect(e, ref){
                ...
                console.log('current checked', this.checked_col_1, this.checked_col_2, this.checked_col_3)
            ...
            appearPickItem(e, ref, index) {
                ...
                if (!e.direction || !this.ready){ return;}
            ...
            checkedItem(ref, idx, animated=true) {
                ...
                if (scrollToItem) {
                    scrollToItem = Array.isArray(scrollToItem)
                        ...
                        : scrollToItem;
                    if (scrollToItem) {
                        dom.scrollToElement(scrollToItem, {animated: animated})
                    }
                }
            },
